...
_G.packer_plugins = {
  ...
  playground = {
    loaded = true,
    path = "/home/diegovsky/.local/share/nvim/site/pack/packer/start/playground",
  ...
  projection = {
    ...
    loaded = true,
    path = "/home/diegovsky/.local/share/nvim/site/pack/packer/start/projection",
  ...
  ["vala.vim"] = {
    loaded = true,
    path = "/home/diegovsky/.local/share/nvim/site/pack/packer/start/vala.vim",
